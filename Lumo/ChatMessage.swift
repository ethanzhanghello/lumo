...
enum ChatAction: String, Codable, CaseIterable {
    ...
    case addItemToList = "add_item_to_list"
    case removeItemFromList = "remove_item_from_list"
    case updateItemQty = "update_item_qty"
    case addRecipeToList = "add_recipe_to_list"
    case planSingleMeal = "plan_single_meal"
    case planWeekAutofill = "plan_week_autofill"
    case showMealPlan = "show_meal_plan"
    case nutritionRecipe = "nutrition_recipe"
    case nutritionDay = "nutrition_day"
    case nutritionWeek = "nutrition_week"
